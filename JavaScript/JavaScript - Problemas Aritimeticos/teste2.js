/*
    Desafio
        Em 2015 um novo record foi alcançado na competição de Coxinhas de Bueno de Andrada, onde 
        Mônica mandou pra dentro 43 coxinhas em apenas 10 minutos, passando se antecessor que conseguiu comer,
        ...
        e o número de participantes na competição, o dono do restaurante precisa que você desenvolva 
        um programa para saber a quantidade média de coxinha que os participantes da competição conseguem devorar.
    ...
    Saida:
        ...
        o número médio de coxinhas consumidas pelos participantes. O resultado deve ser escrito
...
let value = gets().split(" ");

let H = parseInt(value[0]);
let P = parseInt(value[1]);
